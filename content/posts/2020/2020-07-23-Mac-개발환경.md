...
![Mac Terminal](/assets/images/posts/2020/07/20200723_2020-07-23-Mac-개발환경_1.png)
...
![아이클라우드 동기화 문서](/assets/images/posts/2020/07/20200723_2020-07-23-Mac-개발환경_2.png)

`dot(.)`으로 시작하는 파일들의 경우 Mac에서도 숨겨지기 때문에 일부러 `underscore(_)` 사용해서 파일을 생성했습니다.

### 로컬 파일 symbolic link 생성

![심볼릭 링크 연결](/assets/images/posts/2020/07/20200723_2020-07-23-Mac-개발환경_3.png)
