...
- 내가 보낸 데이터를 `중간에서는 모르게, 받은 사람은 알 수 있게` 하는게 목적
  ![](/images/posts/2023/06/20230602_2023-06-02-인증과-전자서명_1.png)
...
- 복호화가 불가능한 해시를 생성하고 이 값으로 변조되지 않았음을 증명
  ![](/images/posts/2023/06/20230602_2023-06-02-인증과-전자서명_2.png)
- 활용하는 대표적인 사례
...
- JWT 구조
  ![](/images/posts/2023/06/20230602_2023-06-02-인증과-전자서명_3.png)
...
- 공유키를 이용하여 전달할 메시지의 해시값을 양쪽에서 생성하여, 메시지의 위변조 여부를 판단
  ![](/images/posts/2023/06/20230602_2023-06-02-인증과-전자서명_4.png)
- Replay Attack
...
- SSL: 대칭키와 공개키 암호화의 장점을 모두 활용한 방법
  ...
  - 이후 통신에서는 각 엣지에서 속도가 빠른 `대칭키` 방식으로 암호 통신
    ![](/images/posts/2023/06/20230602_2023-06-02-인증과-전자서명_5.png)
- TLS: SSL의 개선된 버전
...
- 인증서 체인: 인증서를 신뢰할 수 있도록 서명으로 만들어진 체인
  ![](/images/posts/2023/06/20230602_2023-06-02-인증과-전자서명_6.png)
